...
import com.Deliciouspoint.Delicious.adapter.RestaurantMenuAdapter
import com.Deliciouspoint.Delicious.model.RestaurantMenu
...
class RestaurantMenuActivity : AppCompatActivity() {
    ...
    fun fetchData() {
        if (ConnectionManager().checkConnectivity(this)) {
            ...
            alterDialog.setMessage("Connect to the Internet!")
    ...
    override fun onBackPressed() {
        if (menuAdapter.getSelectedItemCount() > 0) {
            ...
            alterDialog.setMessage("Going back will reset your cart!")
            alterDialog.setPositiveButton("Go Back") { _, _ ->
                super.onBackPressed()
            }
